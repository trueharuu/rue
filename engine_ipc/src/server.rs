use engine_core::{board::Board, game::Game, piece::Piece, queue::Queue, ruleset::AttackConfig};
    ...
    pub async fn handle_one(&mut self, request: Option<Request>) -> Response {
        ...
        match request {
            ...
            Request::Path {
                ...
                let mut g = Game::new(b, current, Queue::from_slice(&queue), AttackConfig::tetra_league());
                g.hold = hold;
