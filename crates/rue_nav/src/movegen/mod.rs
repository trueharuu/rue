...
pub fn generate<const N: usize>(
    ...
    match (p, ruleset.spins) {
        (Piece::T, Spins::None) => {
            generate_inlined::<{ Piece::T }, { Spins::None }, _>(b, y, force)
        }
        (Piece::I, Spins::None) => {
            generate_inlined::<{ Piece::I }, { Spins::None }, _>(b, y, force)
        }
        (Piece::J, Spins::None) => {
            generate_inlined::<{ Piece::J }, { Spins::None }, _>(b, y, force)
        }
        (Piece::L, Spins::None) => {
            generate_inlined::<{ Piece::L }, { Spins::None }, _>(b, y, force)
        }
        (Piece::O, Spins::None) => {
            generate_inlined::<{ Piece::O }, { Spins::None }, _>(b, y, force)
        }
        (Piece::S, Spins::None) => {
            generate_inlined::<{ Piece::S }, { Spins::None }, _>(b, y, force)
        }
        (Piece::Z, Spins::None) => {
            generate_inlined::<{ Piece::Z }, { Spins::None }, _>(b, y, force)
        }
        ...
        (Piece::T, Spins::AllMini) => {
            generate_inlined::<{ Piece::T }, { Spins::AllMini }, _>(b, y, force)
        }
        (Piece::I, Spins::AllMini) => {
            generate_inlined::<{ Piece::I }, { Spins::AllMini }, _>(b, y, force)
        }
        (Piece::J, Spins::AllMini) => {
            generate_inlined::<{ Piece::J }, { Spins::AllMini }, _>(b, y, force)
        }
        (Piece::L, Spins::AllMini) => {
            generate_inlined::<{ Piece::L }, { Spins::AllMini }, _>(b, y, force)
        }
        (Piece::O, Spins::AllMini) => {
            generate_inlined::<{ Piece::O }, { Spins::AllMini }, _>(b, y, force)
        }
        (Piece::S, Spins::AllMini) => {
            generate_inlined::<{ Piece::S }, { Spins::AllMini }, _>(b, y, force)
        }
        (Piece::Z, Spins::AllMini) => {
            generate_inlined::<{ Piece::Z }, { Spins::AllMini }, _>(b, y, force)
        }

        (Piece::T, Spins::AllPlus) => {
            generate_inlined::<{ Piece::T }, { Spins::AllPlus }, _>(b, y, force)
        }
        (Piece::I, Spins::AllPlus) => {
            generate_inlined::<{ Piece::I }, { Spins::AllPlus }, _>(b, y, force)
        }
        (Piece::J, Spins::AllPlus) => {
            generate_inlined::<{ Piece::J }, { Spins::AllPlus }, _>(b, y, force)
        }
        (Piece::L, Spins::AllPlus) => {
            generate_inlined::<{ Piece::L }, { Spins::AllPlus }, _>(b, y, force)
        }
        (Piece::O, Spins::AllPlus) => {
            generate_inlined::<{ Piece::O }, { Spins::AllPlus }, _>(b, y, force)
        }
        (Piece::S, Spins::AllPlus) => {
            generate_inlined::<{ Piece::S }, { Spins::AllPlus }, _>(b, y, force)
        }
        (Piece::Z, Spins::AllPlus) => {
            generate_inlined::<{ Piece::Z }, { Spins::AllPlus }, _>(b, y, force)
        }
    }
}
...
#[inline]
#[must_use]
pub fn count_locks<const P: Piece, const N: usize>(b: &Board<N>, y: i32, force: i32) -> u32 {
